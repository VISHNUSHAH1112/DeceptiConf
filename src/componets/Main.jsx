        ...
        >
            <div className="relative z-10 w-full min-h-screen">
                ...
                <header className="relative z-50 flex-none lg:pt-11">
                    <div className="flex flex-col md:flex-row items-center justify-between px-8 py-6 mx-auto max-w-7xl gap-6 sm:px-6 lg:px-20">

                        {/* EVENT DATE + LOCATION */}
                        <div className="order-1 md:order-2 w-full md:w-auto text-center md:text-left">
                            <p className="flex flex-wrap justify-center md:justify-start items-center gap-2 font-mono text-[15px] text-blue-600">
                                <span>04-06</span>
                                <span>of</span>
                                <span>April,</span>
                                <span>2002</span>
                        ...
                        <div className="flex items-center gap-3 order-2 md:order-1">
                            <svg className="h-12 w-auto" viewBox="0 0 48 48" fill="currentColor">
                                <path
                                    fill="#3B82F6"
                            ...
                            <p className="text-2xl font-semibold drop-shadow text-black">
                                DeceptiConf
                            </p>
                        </div>
                ...
                <div className="max-w-4xl mx-auto pt-24 pb-20 px-8">
                    <h1
                        className="font-display text-5xl sm:text-7xl font-bold tracking-tight drop-shadow-lg text-blue-600"
                    >
                        A design conference
                    ...
                    {/* DESCRIPTION */}
                    <div className="mt-6 space-y-6 text-xl sm:text-2xl tracking-tight drop-shadow-sm text-blue-800">
                        <p>
                    ...
                    {/* STATS */}
                    <div className="grid grid-cols-2 md:flex md:gap-20 text-sm mt-12 text-blue-800">
                        {[
                            ...
                            <div key={i} className="mb-6 md:mb-0">
                                <p className="font-mono text-blue-600">{item.title}</p>
